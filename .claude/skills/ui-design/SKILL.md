...
1. Inspect the existing app, design tokens, component patterns, and `.ui-design/system.md` if present.
...
- **If `.ui-design/system.md` exists:** read it and apply — decisions are made.
...
Always offer to save: "Want me to save these patterns for future sessions?" If yes, write to `.ui-design/system.md`:
